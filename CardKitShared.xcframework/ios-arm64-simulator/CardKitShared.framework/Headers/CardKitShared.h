...
@class CKSBusinessCard, CKSBusinessCardDraft, CKSCameraController, CKSCaptureResult, CKSCaptureResultCancelled, CKSCaptureResultSuccess, CKSKotlinArray<T>, CKSKotlinException, CKSKotlinIllegalStateException, CKSKotlinRuntimeException, CKSKotlinThrowable, CKSScanResult, CKSScanResultCancelled, CKSScanResultSuccess;

@protocol CKSBusinessCardRepository, CKSKotlinIterator, CKSKotlinx_coroutines_coreFlow, CKSKotlinx_coroutines_coreFlowCollector, CKSPlatform;
